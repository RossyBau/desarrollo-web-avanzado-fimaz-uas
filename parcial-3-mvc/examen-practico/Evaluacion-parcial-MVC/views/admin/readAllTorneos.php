                    ...
                    <?php if($rows):?>
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <span class="fa-solid fa-list-check"></span></a>
                                
                                <a href="updateTorneo.php?id=<?= $row['id'] ?>" class="btn btn-success"> 
                                <span class="fa-solid fa-pen-to-square"></span></a>
                                
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#idModal<?= 
                                $row['id'] ?>">
                                <span class="fa-solid fa-trash"></span></button>

                                <div class="modal fade" id="idModal<?= $row['id'] ?>" tabindex="-1" aria-labelledby="Modal<?= $row['id'] ?>" 
                                aria-hidden="true">
